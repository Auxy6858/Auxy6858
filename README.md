...
![Languages I'm currently using](https://go-skill-icons.vercel.app/api/icons?i=rust,odin,lua,d,cs&theme=light)

# My Skills

## Proficient With
![languages/frameworks/tools I excel in](https://go-skill-icons.vercel.app/api/icons?i=cs,dotnet,python,linux,debian,windows,vscode,rider,pycharm,idea,webstorm,figma,github&theme=light)
